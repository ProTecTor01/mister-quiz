...
<div>
    ...
    <form action="{{ route('login') }}" method="POST">
        ...
        <div class="mb4">
            <input class="auth-input center" type="email" name="email" id="email" placeholder="Enter email" value="{{ old('email')}}" required>
        ...
        <div class="mb4">
            <input class="auth-input center" type="password" name="password" id="password" placeholder="Enter password" required>
